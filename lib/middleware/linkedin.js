...
Linkedin.prototype.login = function login(req, res, next) {
  OAuth1.prototype.login.call(this, req, res, next);
  // data.type = 'text/plain'
};

Linkedin.prototype.logout = function logout(req, res, next) {
  var self = this;
...
Linkedin.prototype.auth = function auth(req, res, next) {
