...
Twitter.prototype.login = function login(req, res, next) {
  OAuth1.prototype.login.call(this, req, res, next);
  // data.type = 'text/html'
};

Twitter.prototype.logout = function logout(req, res, next) {
  OAuth1.prototype.logout.call(this, req, res, next);
  // data.type = 'application/json'
};

Twitter.prototype.auth = function auth(req, res, next) {
